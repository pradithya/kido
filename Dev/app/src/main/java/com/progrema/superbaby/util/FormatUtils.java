...
public class FormatUtils {
    ...
    public static Bitmap decodeUri(Uri selectedImage, Context inputContext) throws FileNotFoundException {
        // Decode image size
        BitmapFactory.Options o = new BitmapFactory.Options();
        o.inJustDecodeBounds = true;
        BitmapFactory.decodeStream(inputContext.getContentResolver().openInputStream(selectedImage), null, o);
        ...
        return BitmapFactory.decodeStream(
                inputContext.getContentResolver().openInputStream(selectedImage), null, o2);
    }
}
